...
#define FSCalendarInvalidateCellAppearanceWithDefault(SEL1,SEL2,DEFAULT) \
    ...
    if (cell.substring) {
        FSCalendarInvalidateCellAppearance(preferredSubtitleDefaultColor,substrDefaultColorForDate);
        FSCalendarInvalidateCellAppearance(preferredSubtitleSelectionColor,subtitleSelectionColorForDate);
        FSCalendarInvalidateCellAppearanceWithDefault(preferredSubstrOffset,substrOffsetForDate,CGPointInfinity);
    }
...
- (void)reloadDataForCell:(FSCalendarCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.substring = [self.dataSourceProxy calendar:self substrForDate:date];
