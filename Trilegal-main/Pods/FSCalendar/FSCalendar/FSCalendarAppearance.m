...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _substrFont = [UIFont systemFontOfSize:FSCalendarStandardSubtitleTextSize];
...
- (void)setSubstrFont:(UIFont *)substrFont
{
    if (![_substrFont isEqual:substrFont]) {
        _substrFont = substrFont; 
        [self.calendar configureAppearance];
    }
}
...
- (void)setSubstrOffset:(CGPoint)substrOffset
{
    if (!CGPointEqualToPoint(_substrOffset, substrOffset)) {
...
- (void)setSubstrDefaultColor:(UIColor *)color
{
    if (color) {
        _subtitleColors[@(FSCalendarCellStateNormal)] = color;
    } else {
...
- (void)setSubstrSelectionColor:(UIColor *)color
{
    if (color) {
        _subtitleColors[@(FSCalendarCellStateSelected)] = color;
    } else {
...
- (void)setSubstrTodayColor:(UIColor *)color
{
    if (color) {
        _subtitleColors[@(FSCalendarCellStateToday)] = color;
    } else {
...
- (void)setSubstrPlaceholderColor:(UIColor *)color
{
    if (color) {
        _subtitleColors[@(FSCalendarCellStatePlaceholder)] = color;
    } else {
...
- (void)setSubstrWeekendColor:(UIColor *)color
{
    if (color) {
        _subtitleColors[@(FSCalendarCellStateWeekend)] = color;
    } else {
...
- (void)setSubstrVerticalOffset:(CGFloat)substrVerticalOffset
{
    self.substrOffset = CGPointMake(0, substrVerticalOffset);
}
...
- (CGFloat)substrVerticalOffset
{
    return self.substrOffset.y;
}
...
- (void)setSubstrTextSize:(CGFloat)substrTextSize
{
    self.substrFont = [self.substrFont fontWithSize:substrTextSize];
}
