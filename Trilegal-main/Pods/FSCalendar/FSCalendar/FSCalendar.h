...
- (nullable NSString *)calendar:(FSCalendar *)calendar substrForDate:(NSDate *)date;
...
- (nullable UIColor *)calendar:(FSCalendar *)calendar appearance:(FSCalendarAppearance *)appearance substrDefaultColorForDate:(NSDate *)date;
...
- (CGPoint)calendar:(FSCalendar *)calendar appearance:(FSCalendarAppearance *)appearance substrOffsetForDate:(NSDate *)date;
