...
class MyReimbursementAdapter{
    ...
    init(expenseDate: String?, amount: String?,clientName: String?, matterName: String?,remark: String?,status: String?, paymentType: String?,payto: String?, corporateCard: String?,expenseCatg: String?, costCenter: String?,noFileChoosenTxt: String?,debitToTxt: String?) {
